...
theme.bg_normal     = theme.solarized_base3
theme.bg_focus      = theme.solarized_base2
theme.bg_urgent     = theme.solarized_magenta
theme.bg_minimize   = theme.solarized_base3
theme.bg_systray    = theme.bg_normal

theme.fg_normal     = theme.solarized_base00
theme.fg_focus      = theme.solarized_base01
theme.fg_urgent     = theme.solarized_base1
theme.fg_minimize   = theme.solarized_base1

theme.border_width  = 1
theme.border_normal = theme.solarized_base3
theme.border_focus  = theme.solarized_base3
